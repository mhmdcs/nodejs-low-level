...
server.on('request', (request, response) => { // request object inherits from ReadableStream which inherits from EventEmitter, response object inherits from WritableStream (hence writeHead() and end() methods being called on it), which also inherits from EventEmitter.
